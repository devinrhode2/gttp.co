(function(_) {
    ...
    var gittipURI = window.gittipURI || 'https://www.gittip.com/';
    var _gttp     = window._gttp     || [];
    ...
    Gittip.users = {
        ...
        _get: function(user, endpoint, callback) {
            _.jsonp(gittipURI + encodeURIComponent(user) + '/' + endpoint + '.json', callback);
        },
    ...
    Gittip.widgets = {
        ...
        apply: function(element, cb) {
            ...
            link('profile-link', gittipURI + encodeURIComponent(username) + '/');
            link('link', gittipURI);
        ...
        _.each(jsoncss, function(selector) {
            ...
            _.each(selector, function(properties) {
                ...
                for (property in properties) {
                    ...
                    // elements -- where many browsers will interpret url(//gttp.co)
                    // as url(about://gttp.co)
